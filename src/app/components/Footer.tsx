...
export function Footer() {
  return (
    <footer className="bg-[#452b1e]">
      {/* ── Row 1: Logo + Description ── */}
      <div className="max-w-[1440px] mx-auto px-[20px] md:px-[40px] lg:px-[110px] pt-[40px] md:pt-[50px] lg:pt-[60px] pb-[30px] md:pb-[35px] lg:pb-[45px]">
        <div className="grid grid-cols-1 lg:grid-cols-[240px_1fr] gap-[20px] md:gap-[30px] lg:gap-[80px] items-start">
          {/* Logo — sized to preserve natural aspect ratio (163:30.56) */}
          <div className="w-[163px] h-[31px] shrink-0">
            <VectorFooter />
          </div>
          {/* Description — aligned to start at column 2 */}
          <p className="font-['Noto_Sans'] text-[13px] md:text-[14px] leading-[21px] md:leading-[22px] tracking-[-0.3px] text-white/80 max-w-[780px]">
            Escritório de advocacia especializada em Brasília, fundado pela Dra. Lidiane Sousa Araújo, OAB/DF 34.876. Estrutura presencial no Distrito Federal e atendimento online para todo o Brasil e brasileiros no exterior, com apoio de uma rede de parceiros qualificados. Atuação estratégica em Direito de Família, Regularização de Imóveis, Homologação de Sentença Estrangeira e Consultoria Empresarial.
          </p>
        </div>
      </div>

      {/* ── Row 2: Newsletter + Info Columns ── */}
      <div className="max-w-[1440px] mx-auto px-[20px] md:px-[40px] lg:px-[110px] pb-[30px] md:pb-[35px] lg:pb-[50px]">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-[240px_1fr_1fr_auto] gap-x-[24px] lg:gap-x-[50px] gap-y-[28px] md:gap-y-[36px] items-start">

          {/* Newsletter — below logo, same first column */}
          ...
          <div>
            ...
            <div className="space-y-[12px]">
              <a
                href="mailto:contato@sousaaraujo.adv.br"
                className="flex items-center gap-[10px] text-white hover:text-[#a57255] transition-colors"
              >
                <svg className="w-[18px] h-[14px] shrink-0" fill="none" viewBox="0 0 19 14">
                  <path
                    d="M1.5 0C0.672 0 0 0.672 0 1.5V12.5C0 13.328 0.672 14 1.5 14H17.5C18.328 14 19 13.328 19 12.5V1.5C19 0.672 18.328 0 17.5 0H1.5ZM3.09 1.5H15.91L9.5 6.26L3.09 1.5ZM1.5 2.34L9.18 8.04C9.36 8.17 9.64 8.17 9.82 8.04L17.5 2.34V12.5H1.5V2.34Z"
                    fill="currentColor"
                  />
                </svg>
                <span className="font-['Noto_Sans'] text-[14px] leading-[22px] tracking-[-0.225px]">
                  contato@sousaaraujo.adv.br
                </span>
              </a>
              <a
                href="tel:+5561995991322"
                className="flex items-center gap-[10px] text-white hover:text-[#a57255] transition-colors"
              >
          ...
          <div>
            ...
            <div className="flex items-start gap-[10px]">
              <svg className="w-[12px] h-[17px] shrink-0 mt-[3px]" fill="none" viewBox="0 0 12 17">
                <path
                  d="M6 0C2.69 0 0 2.69 0 6C0 10.5 6 17 6 17C6 17 12 10.5 12 6C12 2.69 9.31 0 6 0ZM6 8.15C4.81 8.15 3.85 7.19 3.85 6C3.85 4.81 4.81 3.85 6 3.85C7.19 3.85 8.15 4.81 8.15 6C8.15 7.19 7.19 8.15 6 8.15Z"
                  fill="white"
                />
              </svg>
              <p className="font-['Noto_Sans'] text-[14px] leading-[22px] tracking-[-0.225px] text-white">
                Edifício Varig - Setor Comercial Norte, quadra 04, bloco B, sala 702, 7 andar Pétala D - Asa Norte, Brasília - DF, 70714-020
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex items-center gap-[14px] text-white">
              <a href="#" aria-label="Instagram" className="hover:text-[#a57255] transition-colors">
                <InstagramIcon />
              </a>
              <a href="#" aria-label="Facebook" className="hover:text-[#a57255] transition-colors">
                <FacebookIcon />
              </a>
              <a href="#" aria-label="TikTok" className="hover:text-[#a57255] transition-colors">
                <TiktokIcon />
              </a>
              <a href="#" aria-label="LinkedIn" className="hover:text-[#a57255] transition-colors">
                <LinkedInIcon />
              </a>
              <a href="#" aria-label="YouTube" className="hover:text-[#a57255] transition-colors">
                <YouTubeIcon />
              </a>
            </div>
          </div>
      ...
      <div className="max-w-[1440px] mx-auto px-[20px] md:px-[40px] lg:px-[110px]">
        <div className="h-px bg-[#a57255]/50" />
      </div>

      {/* ── Row 3: Navigation ── */}
      <div className="max-w-[1440px] mx-auto px-[20px] md:px-[40px] lg:px-[110px] py-[18px] md:py-[22px]">
        <div className="flex flex-col sm:flex-row sm:flex-wrap items-start sm:items-center justify-between gap-[12px] md:gap-[16px]">
          <nav className="flex flex-wrap items-center gap-[16px] md:gap-[20px] lg:gap-[44px]">
            {[
              ...
              <a
                key={item.label}
                href={item.href}
                className="font-['Noto_Sans'] text-[14px] leading-[21px] tracking-[-0.225px] text-white hover:text-[#a57255] transition-colors"
              >
                {item.label}
              </a>
            ))}
          ...
          <a
            href="#contato"
            className="inline-flex items-center gap-[8px] font-['Noto_Sans'] font-medium text-[14px] leading-[25px] tracking-[-0.225px] text-white hover:text-[#a57255] transition-colors group"
          >
            Agendar Atendimento
            <ArrowIcon className="group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-transform" />
          </a>
      ...
      {/* ── Divider ── */}
      <div className="max-w-[1440px] mx-auto px-[20px] md:px-[40px] lg:px-[110px]">
        <div className="h-px bg-[#a57255]/30" />
      </div>

      {/* ── Row 4: Legal / Copyright ── */}
      <div className="max-w-[1440px] mx-auto px-[20px] md:px-[40px] lg:px-[110px] py-[20px] md:py-[28px]">
        <p className="font-['Noto_Sans'] text-[11px] md:text-[12px] leading-[18px] md:leading-[20px] tracking-[-0.18px] text-white/50">
          Termos de Uso &nbsp;·&nbsp; Política de Privacidade © 2026 SA | Sousa Araújo Advocacia · Todos os direitos reservados Comunicação em conformidade com o Provimento OAB 205/2021 – Desenvolvido por Mix7
        </p>
      </div>
    </footer>
  );
