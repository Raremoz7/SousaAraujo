...
import svgPaths from "./svg-hg7bbee7wb";
import imgImage from "figma:asset/165c2fa2b945b6d767d5ca0d5ceae23b97f95901.png";
...
function GroupBackgroundImage1() {
  return (
    <BackgroundImage additionalClassNames="inset-[5.23%_5.05%_3.81%_3.57%]">
      <g id="Group">
        <path d={svgPaths.p1238f200} id="Vector" stroke="var(--stroke-0, white)" strokeWidth="1.02093" />
      </g>
    </BackgroundImage>
...
export default function Faq() {
  return (
    <div className="bg-[#161312] relative size-full" data-name="FAQ">
      <div className="absolute h-[460px] left-0 right-0 top-0" data-name="Image">
        <div aria-hidden="true" className="absolute inset-0 pointer-events-none">
          <div className="absolute inset-0 overflow-hidden">
            <img alt="" className="absolute h-[188.99%] left-[-4.08%] max-w-none top-[-56.59%] w-[108.17%]" src={imgImage} />
          </div>
      ...
      <div className="-translate-y-1/2 absolute flex flex-col font-['Marcellus:Regular',sans-serif] h-[111px] justify-center leading-[0] left-[80px] not-italic text-[58px] text-white top-[242.5px] tracking-[-0.87px] w-[632px]">
        <p className="leading-[66px]">FAQ</p>
      </div>
      <div className="-translate-y-1/2 absolute flex flex-col font-['Marcellus:Regular',sans-serif] h-[107px] justify-center leading-[52px] left-[170px] not-italic text-[43px] text-white top-[630.5px] tracking-[-0.516px] w-[311.373px]">
        <p className="mb-0">Perguntas</p>
        <p>frequentes</p>
      </div>
      <div className="-translate-y-1/2 absolute flex flex-col font-['Noto_Sans:Regular',sans-serif] h-[140px] justify-center leading-[25px] left-[170px] not-italic text-[18px] text-white top-[773px] tracking-[-0.225px] w-[347px] whitespace-pre-wrap">
      ...
      <div className="absolute border-[#e0dede] border-b border-solid h-[854px] left-[610px] right-[170px] top-[554px]" data-name="Tablist">
        <div className="absolute h-[77px] left-0 right-0 top-0" data-name="Tab">
          ...
          <div className="-translate-y-1/2 absolute flex flex-col font-['Noto_Sans:Regular',sans-serif] h-[35px] justify-center leading-[0] left-0 not-italic text-[25px] text-white top-[43.5px] tracking-[-0.525px] w-[259.803px]">
            <p className="leading-[35px]">Onde fica o escritório?</p>
          </div>
          <div className="absolute left-[650px] opacity-0 overflow-clip size-[14px] top-[36.5px]" data-name="SVG">
            <GroupBackgroundImage />
          </div>
          <div className="absolute h-[2px] left-[650px] top-[42.5px] w-[14px]" data-name="SVG">
            <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 2">
              <g clipPath="url(#clip0_16_2354)" id="SVG">
                <path d="M0.875 1H13.125" id="Vector" stroke="var(--stroke-0, #B58468)" strokeLinecap="round" strokeWidth="1.75" />
              </g>
              <defs>
          ...
          <div className="-translate-y-1/2 absolute flex flex-col font-['Lora:Bold',sans-serif] font-bold h-[62px] justify-center leading-[0] left-[272px] text-[32px] text-[red] top-[27px] tracking-[-0.516px] w-[48px]">
            <p className="leading-[32px]">H2</p>
          </div>
        </div>
        <div className="-translate-y-1/2 absolute flex flex-col font-['Roboto:Regular',sans-serif] font-normal h-[66px] justify-center leading-[0] left-px text-[15px] text-white top-[111px] tracking-[-0.225px] w-[574.06px]" style={{ fontVariationSettings: "'wdth' 100" }}>
          <p className="leading-[23px]">O escritório da Sousa Araújo Advocacia está localizado em Brasília/DF, com atendimento presencial e online para todo o Brasil e brasileiros no exterior.</p>
        </div>
        <div className="absolute border-[#e0dede] border-solid border-t h-[94px] left-0 right-0 top-[195px]" data-name="Tab">
          ...
          <BackgroundImage1 additionalClassNames="w-[356.176px]">Vocês atendem online?</BackgroundImage1>
          <div className="absolute left-[650px] overflow-clip size-[14px] top-[36.5px]" data-name="SVG">
            <GroupBackgroundImage />
          </div>
          <SvgBackgroundImage />
          <div className="-translate-y-1/2 absolute flex flex-col font-['Lora:Bold',sans-serif] font-bold h-[62px] justify-center leading-[0] left-[254px] text-[32px] text-[red] top-[30px] tracking-[-0.516px] w-[48px]">
            <p className="leading-[32px]">H2</p>
          </div>
        </div>
        <div className="absolute border-[#e0dede] border-solid border-t h-[94px] left-0 right-0 top-[289px]" data-name="Tab">
          <div className="absolute bottom-[calc(34.04%+0.34px)] left-0 top-[calc(28.72%-0.71px)] w-[16.72px]" data-name="Rectangle" />
          <BackgroundImage1 additionalClassNames="w-[389px]">O que é a Consulta de Viabilidade?</BackgroundImage1>
          <div className="absolute left-[650px] overflow-clip size-[14px] top-[36.5px]" data-name="SVG">
            <GroupBackgroundImage />
          </div>
          <SvgBackgroundImage />
          <div className="-translate-y-1/2 absolute flex flex-col font-['Lora:Bold',sans-serif] font-bold h-[62px] justify-center leading-[0] left-[401px] text-[32px] text-[red] top-[57px] tracking-[-0.516px] w-[48px]">
            <p className="leading-[32px]">H2</p>
          </div>
        </div>
        <div className="absolute border-[#e0dede] border-solid border-t h-[94px] left-0 right-0 top-[383px]" data-name="Tab">
          <div className="absolute bottom-[calc(34.04%+0.34px)] left-0 top-[calc(28.72%-0.71px)] w-[16.72px]" data-name="Rectangle" />
          <BackgroundImage1 additionalClassNames="w-[276.913px]">Alliance Of Legal Experts</BackgroundImage1>
          <div className="absolute left-[650px] overflow-clip size-[14px] top-[36.5px]" data-name="SVG">
            <GroupBackgroundImage />
          </div>
          <SvgBackgroundImage />
          <div className="-translate-y-1/2 absolute flex flex-col font-['Lora:Bold',sans-serif] font-bold h-[62px] justify-center leading-[0] left-[288px] text-[32px] text-[red] top-[39px] tracking-[-0.516px] w-[48px]">
            <p className="leading-[32px]">H2</p>
          </div>
        </div>
        <div className="absolute border-[#e0dede] border-solid border-t h-[94px] left-0 right-0 top-[477px]" data-name="Tab">
          <div className="absolute bottom-[calc(34.04%+0.34px)] left-0 top-[calc(28.72%-0.71px)] w-[16.72px]" data-name="Rectangle" />
          <BackgroundImage1 additionalClassNames="w-[259.803px]">O que é o Método SAA?</BackgroundImage1>
          <div className="absolute left-[650px] overflow-clip size-[14px] top-[36.5px]" data-name="SVG">
            <GroupBackgroundImage />
          </div>
          <SvgBackgroundImage />
          <div className="-translate-y-1/2 absolute flex flex-col font-['Lora:Bold',sans-serif] font-bold h-[62px] justify-center leading-[0] left-[306px] text-[32px] text-[red] top-[38px] tracking-[-0.516px] w-[48px]">
            <p className="leading-[32px]">H2</p>
          </div>
        </div>
        <div className="absolute border-[#e0dede] border-solid border-t h-[94px] left-0 right-0 top-[571px]" data-name="Tab">
          <div className="absolute bottom-[calc(34.04%+0.34px)] left-0 top-[calc(28.72%-0.71px)] w-[16.72px]" data-name="Rectangle" />
          <BackgroundImage1 additionalClassNames="w-[415.465px]">Quanto custa uma consulta?</BackgroundImage1>
          <div className="absolute left-[650px] overflow-clip size-[14px] top-[36.5px]" data-name="SVG">
            <GroupBackgroundImage />
          </div>
          <SvgBackgroundImage />
          <div className="-translate-y-1/2 absolute flex flex-col font-['Lora:Bold',sans-serif] font-bold h-[62px] justify-center leading-[0] left-[309px] text-[32px] text-[red] top-[51px] tracking-[-0.516px] w-[48px]">
            <p className="leading-[32px]">H2</p>
          </div>
        </div>
        <div className="absolute border-[#e0dede] border-solid border-t h-[94px] left-0 right-0 top-[665px]" data-name="Tab">
          <div className="absolute bottom-[calc(34.04%+0.34px)] left-0 top-[calc(28.72%-0.71px)] w-[16.72px]" data-name="Rectangle" />
          <BackgroundImage1 additionalClassNames="w-[319px]">Vocês garantem resultado?</BackgroundImage1>
          <div className="absolute left-[650px] overflow-clip size-[14px] top-[36.5px]" data-name="SVG">
            <GroupBackgroundImage />
          </div>
          <SvgBackgroundImage />
          <div className="-translate-y-1/2 absolute flex flex-col font-['Lora:Bold',sans-serif] font-bold h-[62px] justify-center leading-[0] left-[330px] text-[32px] text-[red] top-[52px] tracking-[-0.516px] w-[48px]">
            <p className="leading-[32px]">H2</p>
          </div>
        </div>
        <div className="absolute border-[#e0dede] border-solid border-t h-[94px] left-0 right-0 top-[759px]" data-name="Tab">
          <div className="absolute bottom-[calc(34.04%+0.34px)] left-0 top-[calc(28.72%-0.71px)] w-[16.72px]" data-name="Rectangle" />
          <BackgroundImage1 additionalClassNames="w-[477px]">Meu imóvel não tem escritura. O que fazer?</BackgroundImage1>
          <div className="absolute left-[650px] overflow-clip size-[14px] top-[36.5px]" data-name="SVG">
            <GroupBackgroundImage />
          </div>
          <SvgBackgroundImage />
          <div className="-translate-y-1/2 absolute flex flex-col font-['Lora:Bold',sans-serif] font-bold h-[62px] justify-center leading-[0] left-[477px] text-[32px] text-[red] top-[34px] tracking-[-0.516px] w-[48px]">
            <p className="leading-[32px]">H2</p>
          </div>
        </div>
      </div>
      <div className="-translate-x-1/2 absolute bottom-[704px] h-[837px] left-1/2 w-[1440px]" data-name="Background">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute backdrop-blur-[9px] bg-[rgba(22,19,18,0.36)] bottom-[80px] right-[80px] top-[80px] w-[650px]" data-name="Overlay+OverlayBlur">
          ...
          <div className="absolute h-[23px] left-[61px] top-[143.48px] w-[296.78px]" data-name="Link">
            ...
            <BackgroundImage2 additionalClassNames="left-[22px] w-[482px]">Edifício Varig - Asa Norte, Brasília - DF, 70714-020</BackgroundImage2>
          </div>
          <div className="absolute h-[23px] left-[61px] top-[171.48px] w-[148.33px]" data-name="Link">
            ...
            <BackgroundImage2 additionalClassNames="left-[25px] w-[166px]">+55 61 99599-1322</BackgroundImage2>
          </div>
        ...
        <div className="-translate-x-1/2 absolute contents left-1/2 top-[837px]">
          ...
          <div className="absolute inset-[1098px_646px_-415px_557px]" data-name="Paragraph">
            <div className="-translate-y-1/2 absolute flex flex-col font-['Noto_Sans:Medium',sans-serif] h-[23px] justify-center leading-[0] left-[-0.39px] not-italic text-[#b58468] text-[21px] top-[12.01px] tracking-[-0.42px] w-[223px]">
          ...
          <div className="absolute inset-[1098.17px_362.21px_-543.17px_840.59px]" data-name="Paragraph">
            <div className="-translate-y-1/2 absolute flex flex-col font-['Noto_Sans:Medium',sans-serif] h-[30px] justify-center leading-[0] left-0 not-italic text-[#b58468] text-[21px] top-[15px] tracking-[-0.42px] w-[181.873px]">
              <p className="leading-[30px]">Nossa Localização</p>
            </div>
          </div>
          <div className="absolute inset-[1098px_82px_-415px_1121px]" data-name="Container">
            <div className="-translate-y-1/2 absolute flex flex-col font-['Noto_Sans:Medium',sans-serif] h-[30px] justify-center leading-[0] left-0 not-italic text-[#b58468] text-[21px] top-[15.17px] tracking-[-0.42px] w-[139px]">
          ...
          <div className="absolute h-[30px] left-[63px] right-[941px] top-[1098px]" data-name="Form - Contact form">
            <div className="absolute border-[#c1bbbb] border-b border-solid h-[38px] left-[18px] overflow-clip right-[165px] top-0" data-name="Input">
              <div className="absolute h-[18px] left-0 overflow-clip right-0 top-[9.5px]" data-name="Container">
                <div className="-translate-x-1/2 -translate-y-1/2 absolute flex flex-col font-['Noto_Sans:Regular',sans-serif] h-[18px] justify-center leading-[0] left-[80.5px] not-italic text-[#b58468] text-[13px] text-center top-[9.5px] w-[205px]">
          ...
          <div className="absolute border-[#b58468] border-b border-solid bottom-[-558px] h-[2px] left-[81px] w-[1265px]" data-name="Horizontal Divider" />
          ...
          <BackgroundImage3 additionalClassNames="left-[175px] top-[1358.5px] w-[42.138px]">Sobre</BackgroundImage3>
          <BackgroundImage3 additionalClassNames="left-[269px] top-[1359.5px] w-[120px]">Áreas de Atuação</BackgroundImage3>
          <BackgroundImage3 additionalClassNames="left-[441px] top-[1358.5px] w-[38px]">Blog</BackgroundImage3>
          <BackgroundImage3 additionalClassNames="left-[531px] top-[1359.5px] w-[30px]">FAQ</BackgroundImage3>
          <BackgroundImage3 additionalClassNames="left-[613px] top-[1359.5px] w-[66px]">Contato</BackgroundImage3>
          ...
          <div className="absolute contents inset-[108.62%_68.82%_-16.99%_5.56%]">
            <div className="absolute inset-[109.7%_68.82%_-14.72%_10.83%]" data-name="Group">
              <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 293 42">
                <g id="Group">
                  <path d={svgPaths.p3563c000} fill="var(--fill-0, white)" id="Vector" />
                  <path d={svgPaths.p2d23480} fill="var(--fill-0, white)" id="Vector_2" />
                  <path d={svgPaths.pfc3d600} fill="var(--fill-0, white)" id="Vector_3" />
                  <path d={svgPaths.p23033000} fill="var(--fill-0, white)" id="Vector_4" />
                  <path d={svgPaths.p34d0440} fill="var(--fill-0, white)" id="Vector_5" />
                  <path d={svgPaths.p2010200} fill="var(--fill-0, white)" id="Vector_6" />
                  <path d={svgPaths.p206c9e00} fill="var(--fill-0, white)" id="Vector_7" />
                  <path d={svgPaths.p24d0b780} fill="var(--fill-0, white)" id="Vector_8" />
                  <path d={svgPaths.pbf168a0} fill="var(--fill-0, white)" id="Vector_9" />
                  <path d={svgPaths.p1b108f80} fill="var(--fill-0, white)" id="Vector_10" />
                  <path d={svgPaths.p31ed1a00} fill="var(--fill-0, white)" id="Vector_11" />
                </g>
              </svg>
            </div>
            <div className="absolute inset-[115.19%_76.04%_-16.15%_18.13%]" data-name="Group">
              <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 84 8">
                <g id="Group">
                  <path d={svgPaths.p33739180} fill="var(--fill-0, white)" id="Vector" />
                  <path d={svgPaths.peb9c80} fill="var(--fill-0, white)" id="Vector_2" />
                  <path d={svgPaths.p4e10e00} fill="var(--fill-0, white)" id="Vector_3" />
                  <path d={svgPaths.p36871880} fill="var(--fill-0, white)" id="Vector_4" />
                  <path d={svgPaths.p20f0aa00} fill="var(--fill-0, white)" id="Vector_5" />
                  <path d={svgPaths.pdfd3c80} fill="var(--fill-0, white)" id="Vector_6" />
                  <path d={svgPaths.p13568580} fill="var(--fill-0, white)" id="Vector_7" />
                  <path d="M74 8H72V0H74V8Z" fill="var(--fill-0, white)" id="Vector_8" />
                  <path d={svgPaths.p22ffc0f0} fill="var(--fill-0, white)" id="Vector_9" />
                </g>
              </svg>
            </div>
            <div className="absolute inset-[108.62%_90.07%_-16.99%_5.56%]" data-name="Group">
              <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 63 70">
                <g id="Group">
                  <path d={svgPaths.pd9fc9f0} fill="var(--fill-0, #D1B9A7)" id="Vector" />
                  <path d={svgPaths.p14db9a00} fill="var(--fill-0, #D1B9A7)" id="Vector_2" />
                  <path d={svgPaths.p1c7cc280} fill="var(--fill-0, #D1B9A7)" id="Vector_3" />
                  <path d={svgPaths.p1a0dc800} fill="var(--fill-0, #D1B9A7)" id="Vector_4" />
                </g>
              </svg>
            </div>
          </div>
      ...
      <div className="-translate-y-1/2 absolute flex flex-col font-['Lora:Bold',sans-serif] font-bold h-[62px] justify-center leading-[0] left-[231px] text-[32px] text-[red] top-[251px] tracking-[-0.516px] w-[48px]">
