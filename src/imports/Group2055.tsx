...
import svgPaths from "./svg-r0rdaxikom";
...
export default function Group2() {
  return (
    <div className="relative size-full">
      ...
      <div className="absolute h-[30px] left-[63px] right-[941px] top-[261px]" data-name="Form - Contact form">
      ...
      <div className="-translate-y-1/2 absolute flex flex-col font-['Noto_Sans:Regular',sans-serif] h-[91px] justify-center leading-[0] left-[568px] not-italic text-[15px] text-white top-[110.5px] tracking-[-0.525px] w-[773px]">
      ...
      <div className="absolute contents inset-[10.25%_68.82%_79.81%_5.56%]">
        <div className="absolute inset-[11.53%_68.82%_82.5%_10.83%]" data-name="Group">
        ...
        <div className="absolute inset-[18.06%_76.04%_80.8%_18.13%]" data-name="Group">
        ...
        <div className="absolute inset-[10.25%_90.07%_79.81%_5.56%]" data-name="Group">
